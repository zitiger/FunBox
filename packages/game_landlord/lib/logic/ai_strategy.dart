...
class AIStrategy {
  static List<PlayingCard>? choosePlay(
    List<PlayingCard> hand,
    CardPattern? lastPlay,
    bool isLandlord,
  ) {
  ...
  static List<PlayingCard>? _chooseFirstPlay(
    ...
    bool isBombOrRocket(List<PlayingCard> cards) {
      ...
      return pattern.type == PatternType.bomb ||
          pattern.type == PatternType.rocket;
    }
    ...
    plays.sort((a, b) {
      ...
      final typeCmp = typePriority(
        patternA!.type,
      ).compareTo(typePriority(patternB!.type));
  ...
  static List<PlayingCard>? _chooseBeatPlay(
    List<PlayingCard> sorted,
    CardPattern lastPlay,
    bool isLandlord,
  ) {
